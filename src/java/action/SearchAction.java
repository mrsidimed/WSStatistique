...
//        }
        ...
        retour = dao.getStatistique(idEntite1  , dateDebut, dateFin);
...
public String sendStatistiqueOfAllOperators() throws ParseException {
    ...
    retourOfAllOperators = libelle + "__" + dao.getStatistique(idEntite1, dateDebut, dateFin);
...
//        }
        ...
        retourOfAllOperators = operateur+"__"+dao.getStatistique(idEntite1  , dateDebut, dateFin);
        System.out.print("retour1 = "+ retourOfAllOperators+"\n");
        return "pd4ml";
    }
    ...
    public String sendStatistiqueOfAllOperators2() throws ParseException {
        ...
        mattel = dao.getStatistique(11 , dateDebut, dateFin);
        mauritel = dao.getStatistique(5 , dateDebut, dateFin);
        chinguitel = dao.getStatistique(2 , dateDebut, dateFin);
